...
public class FibonacciAndPrimeNumberIterators {
	...
	public static int FibonacciIterator(int fibMax){
		// start elapsed Fibonacci time
		startFibonacciTime = System.currentTimeMillis();
		// increment counter for total occurrences of Fibonacci sequence
		fibCount++;
		// declare new List
		List<Integer> list;
		// declare new ArrayList
		list = new ArrayList<>();
		// set first elements for Fibonacci
		int a = 0, b = 1;
		// while loop to iterate the elements
		while (a <= fibMax) {
		...
		// print to console the Fibonacci sequence using a for loop
		System.out.println("\nFibonacci sequence in descending order up to " + fibMax + " is: ");
		for (int i = list.size()-1; i >=0; i--) {
			fibOutputCount++;
			System.out.print(list.get(i)+" ");		
		}
		// end for loop and end counter for time, calculate total time 
	...
	// close FibonacciIterator
	
	// declare PrimeNumberIterator method
	public static int PrimeNumberIterator(int maxPrime){
		// start elapsed time for PrimeNumberIterator method
		startPrimeTime = System.currentTimeMillis();
		// increment counter for Prime
		primeCount++;
		// declare new integer array
		int[] array=new int[10000];
		// declare counters
        int i,j=0;
        // declare boolean variable 
        boolean isPrime;
        // iterate through the numbers and use CheckPrime method to see if number is prime
        ...
        // print to console prime numbers using a for loop
        int n=j;
        ...
        // end elapsed time and calculate total time
	...
	// declare CheckPrime method 
    public static boolean CheckPrime(int numberToCheck) {
        // declare int variable for remainder
    	int remainder;
    	// for loop checking to see if number is prime returning accordingly
