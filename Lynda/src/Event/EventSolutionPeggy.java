...
public class EventSolutionPeggy {
	...
	// constructor
	public EventSolutionPeggy(String type) {
		eventType = type;
		guests = 0;
		eventDate = null;
	...
	public EventSolutionPeggy(String type, String eventDate) {
		eventType = type;
		guests = 0;
	...
	public EventSolutionPeggy(String type, String eventDate, int numGuests) {
		eventType = type;
		guests = numGuests;
		this.eventDate = eventDate;
		SetEventNumber(eventType);
